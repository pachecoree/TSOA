/**
 * Cacho Robledo Vega Renato, Práctica 1
 * 
 */
...
import sistemaDistribuido.sistema.clienteServidor.modoUsuario.CachoRenato.ProcesoCliente;
	...
	class ManejadorSolicitud implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if (com.equals("Solicitar")){
				...
				proc.recibirParametros(codigosOperacion.getSelectedIndex(),campoMensaje.getText());
